...
import EditBalanceCard from "../components/EditBalanceCard";
...
export default function Balances() {
  ...
  const handleRemove = () => {
    axios
      .delete(`http://localhost:5000/balances/${balance._id}`, {
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
      })
  ...
  return (
    <div className="flex h-[1024px]">
            ...
            <div className="flex flex-col bg-white p-8 rounded-md">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="text-neutral font-bold px-4 py-2 rounded-md mt-4"
                >
                  Remove
                </button>
              </div>
      ...
      {add && <EditBalanceCard set={() => setAdd(false)} userId={isUser._id} />}
      </div>
    </div>
  );
}
